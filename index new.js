...
//------------------------------------withdraw----------------------
  ...
  harvest4 = (amount) => {
    ...
    this.amount5 = "3";
    console.log('amount',this.amount5);
    this.setState({ loading: true });
    //let new_amount = parseInt(amount)
   var amount = web3.utils.toWei((this.amount5), "Ether");
    const { rewardPool3 } = this.state;
  // const tx2= await rewardPool.methods.getReward();
    //const tx = rewardPool.methods.stake(amount);
  ...
  // const tx2= await rewardPool.methods.getReward();
    ...
    window.alert("Deoposited"+this.amount1);
   // console.log("mm",tx)
...
//4-------------------
   ...
   onStake4 = (amount) => {
    ...
    this.amount5 = this.state.username;
    this.total= this.total+parseInt(this.amount5);
     console.log('amount4',this.total);
     this.setState({ loading: true ,
      dep_amount:"",});
     //let new_amount = parseInt(amount)
                 ...
                 <tr>
                   <td style={{paddingLeft:'20px'}}>
                     <div style={{width:'270px',height:'200px',padding:'10px 10px'}}>
                       ...
                       <input  type='text' value={this.state.dep_amount} onChange={this.myChangeHandler} required type="text" placeholder="0   MAX" style={{width:'225px' ,height:'33px', borderRadius:'10px', backgroundColor:'#323131', border:'1px solid white', color:'white', marginTop:'3px'}}/>
                       <br></br><br></br>
                   ...
                   <td style={{paddingLeft:'5px'}}>
                     <div style={{width:'270px',height:'200px',backgroundColor:'black',padding:'15px 15px', borderRadius:'10px'}}>
                           ...
                           <input ref={this.ent_amount} value={this.state.withdraw_amount} type="text"  placeholder="0                                                MAX" style={{width:'225px' ,height:'33px', borderRadius:'10px', backgroundColor:'#323131', border:'1px solid white', color:'white'}}/>
                       <br></br><br></br>
                  ...
                  <tr>
                    <td style={{paddingLeft:'20px'}}>
                      <div style={{width:'270px',height:'200px',padding:'15px 15px'}}>
                            ...
                            <input type="text" value={this.state.dep_amount} onChange={this.myChangeHandler} placeholder="0              MAX" style={{width:'225px' ,height:'33px', borderRadius:'10px', backgroundColor:'#323131', border:'1px solid white', color:'white', marginTop:'3px'}}/>
                        <br></br><br></br>
     ...
     <div className="Box" style={{border:'1px solid yellow', height:'500px'}}>
               ...
               <table>
                   <tr>
                     ...
                     <td style={{paddingLeft:'40px',fontSize:'12px'}}>
                      <span style={{marginLeft:'20px'}}>{this.amount5}</span> <br/>
                       <span style={{opacity:'0.5'}}>Deposited</span>
                     </td>
                     <td style={{paddingLeft:'40px',fontSize:'12px'}}>
                     <span style={{color:'yellow'}}><marquee width="86%" behavior="alternate" direction="up" height="30px">
                  ...
                  <tr>
                    <td style={{paddingLeft:'20px'}}>
                      <div style={{width:'270px',height:'200px',padding:'15px 15px'}}>
                       ...
                       <button onClick={this.onStake4} style={{padding:'8px', borderRadius:'10px', border:'none',backgroundColor:'gray',color:'white',width:'235px'}}>
                         Deposit to Vault
                       </button>
                    ...
                    <td style={{paddingLeft:'5px'}}>
                      <div style={{width:'270px',height:'200px',backgroundColor:'black',padding:'15px 15px', borderRadius:'10px'}}>
                        ...
                        <input type="text" ref={this.ent_amount} placeholder="0                                                  MAX" style={{width:'225px' ,height:'33px', borderRadius:'10px', backgroundColor:'#323131', border:'1px solid white', color:'white'}}/>
                        <br></br><br></br>
    
                       <button onClick={this.withdraw4} value={this.state.withdraw_amount} style={{padding:'8px', borderRadius:'10px',border:'none', backgroundColor:'gray',color:'white',width:'235px'}}>
                        Withdraw to Wallet
                       </button>
                      ...
                      <div style={{width:'270px',height:'200px',backgroundColor:'black',padding:'15px 15px', borderRadius:'10px'}}>
                        ...
                        <table>
                          ...
                          <tr>
                            ...
                            <td>
                            <span></span> <span style={{color:'gray'}}>{this.amount5}</span>
                            </td>
                          </tr>
                        </table>
